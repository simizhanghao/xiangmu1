...
def main() -> None:
    ...
    parser.add_argument("--provider", choices=("duckduckgo", "brave", "searxng"), default="duckduckgo")
    parser.add_argument("--top-k", type=int, default=5)
    parser.add_argument("--output", default="results/54_web_zero_shot/adapter_smoke.json")
    args = parser.parse_args()
    adapter = WebAdapter(provider=args.provider, cache_dir="results/54_web_zero_shot/cache")
